...
{
    public static async Task<string> DownloadFile(string httpPath, string name)
    {
        string downloadUrl = $@"https://arquivos.receitafederal.gov.br{httpPath}\{name}";
        ...
        string outputPath = Program.AppConfig.DatabasePath;
